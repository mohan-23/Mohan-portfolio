const Styles = {
  heroHeadText:
    "text-violet-800 lg:text-[70px] sm:text-[60px] xs:text-[40px] text-[40px] lg:leading-[98px] mt-2",
  heroSubText:
  ...
  sectionText: "mt-4 pl-8 text-orange-500 text-[17px] leading-[30px] max-w-3xl",
};
